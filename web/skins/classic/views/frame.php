...
$sql = 'SELECT E.*,M.Name AS MonitorName,M.Width,M.Height,M.DefaultScale,M.VideoWriter FROM Events AS E INNER JOIN Monitors AS M ON E.MonitorId = M.Id WHERE E.Id = ?';
